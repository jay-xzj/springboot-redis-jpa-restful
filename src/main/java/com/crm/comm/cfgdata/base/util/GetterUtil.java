...
public class GetterUtil {
	...
	public static int getInteger(int value,int defaultValue) {
	...
	public static String getString(Object value) {
		String fval = ObjectUtil.obj2String(value);
		return getString(fval, DEFAULT_STRING);
	}
	...
	public static String get(String value, String defaultValue) {
		if (StringUtil.isNotEmpty(value)) {
			value = value.trim();
			if("null".equals(value)) value = defaultValue;
	...
	public static String getString_W(String value){
		if (StringUtil.isNotEmpty(value)) {
			value = value.trim();
			if("null".equals(value)) value = DEFAULT_STRING;
			if(StringUtil.isNotEmpty(value)){
				return _trim(value);
			}
		}
	...
	private static String _trim(String value) {
		if (value != null) {
			value = value.trim();
			value.replaceAll(" ", StringPool.BLANK);
		}
		return value;
	}
