...
public class BUSI_INFO implements java.io.Serializable {
    ...
    **/
     ...
     * @param reader
    **/
    public static esbInvoke.xbean.BUSI_INFO unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (esbInvoke.xbean.BUSI_INFO) Unmarshaller.unmarshal(esbInvoke.xbean.BUSI_INFO.class, reader);
