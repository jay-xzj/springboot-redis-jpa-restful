...
public class BUSI_INFODescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public BUSI_INFODescriptor() {
        ...
        //-- _APP_CODE
        desc = new XMLFieldDescriptorImpl(java.lang.String.class, "_APP_CODE", "APP_CODE", NodeType.Element);
        desc.setImmutable(true);
        handler = (new XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    BUSI_INFO target = (BUSI_INFO) object;
                    target.setAPP_CODE( (java.lang.String) value);
                }
                catch (Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
    ...
    } //-- com.asiainfo.scrm.module.res.flowdetail.xbeans.ESB_CS_QRY_RECORD_FLOW_002.BUSI_INFODescriptor()
    ...
    **/
    ...
    {
        return com.crm.flowdetail.xbeans.esb_cs_qry_record_flow_002.BUSI_INFO.class;
